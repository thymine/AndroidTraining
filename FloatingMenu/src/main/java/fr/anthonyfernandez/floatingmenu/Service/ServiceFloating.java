        ...
        try {
            ...
            popup.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View view, int position, long id3) {
                    ...
                    try {
                        i = manager.getLaunchIntentForPackage(apps.get(position).pname);
                        if (i == null)
...
//        notification.flags = Notification.FLAG_AUTO_CANCEL | Notification.FLAG_ONGOING_EVENT;
        ...
        Notification noti = new Notification.Builder(getApplicationContext())
                ...
                .setSmallIcon(R.drawable.floating2)
                .setLargeIcon(BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.floating2))
