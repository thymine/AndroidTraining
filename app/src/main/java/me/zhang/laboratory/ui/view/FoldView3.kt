    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        ...
        for (i in 0 until FOLD_COUNT) {
            ...
            val dst = floatArrayOf(
                    ...
                    foldItemWidth * (i + 1), if (isEven) bitmap.height.toFloat() + depth else bitmap.height.toFloat(),
                    foldItemWidth * i, if (isEven) bitmap.height.toFloat() else bitmap.height.toFloat() + depth
            )
