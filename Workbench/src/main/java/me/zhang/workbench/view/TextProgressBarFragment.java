 ...
 */
public class TextProgressBarFragment extends Fragment {
    ...
    public static TextProgressBarFragment newInstance(String title) {

        Bundle args = new Bundle();
        args.putString(FRAGMENT_TITLE, title);

        TextProgressBarFragment fragment = new TextProgressBarFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_text_progress_bar, container, false);
