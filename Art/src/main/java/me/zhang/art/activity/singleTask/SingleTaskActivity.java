...
/**
 * Created by Li on 6/6/2016 9:46 PM.
 */
public class SingleTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        openAButton.setText("Open AlphaActivity");
        openAButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SingleTaskActivity.this, AlphaActivity.class));
            }
        });
        ...
        Button openAnotherSingleTaskButton = new Button(this);
        openAnotherSingleTaskButton.setLayoutParams(new LinearLayout.LayoutParams(MATCH_PARENT, WRAP_CONTENT));
        openAnotherSingleTaskButton.setText("Open Another SingleTask");
        openAnotherSingleTaskButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SingleTaskActivity.this, AnotherSingleTaskActivity.class));
            }
        });

        container.addView(openAButton);
        container.addView(openSelfButton);
        container.addView(openAnotherSingleTaskButton);
