...
public class MyExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(me.zhang.lab.R.layout.item_row, null);
        }
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(me.zhang.lab.R.layout.item_group, null);
        }
        textView = (TextView) convertView.findViewById(me.zhang.lab.R.id.textView1);
